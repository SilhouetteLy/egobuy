 ...
 * @description:
 */
public class BaseTxException extends RuntimeException {

    private static final long serialVersionUID = 1817067724006087108L;
    ...
    public BaseTxException() {
    }

    public BaseTxException(Throwable cause) {
        super(cause);
    }

    public BaseTxException(String message, Throwable cause) {
        super(message, cause);
    }

    public BaseTxException(String exceptionCode, String exceptionMsg) {
        this.exceptionCode = exceptionCode;
        this.exceptionMsg = exceptionMsg;
    }

    public BaseTxException(String exceptionMethod, String exceptionMethodName,
    ...
    public BaseTxException(String exceptionCode) {
        this.exceptionCode = exceptionCode;
    }
